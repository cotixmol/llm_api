...
class LLMService:
    def __init__(self, model_path: str) -> None:
        ...
        self.model = AutoModelForCausalLM.from_pretrained(model_path, device_map="auto", use_cache=True)
        self.tokenizer = AutoTokenizer.from_pretrained(model_path, use_fast=True, device_map="auto", padding_side="left")
