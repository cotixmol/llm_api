...
tracer_provider = register(protocol=node_config['tracing_params']['tracing_protocol'], project_name=node_config['tracing_params']['tracing_project_name'], batch=node_config['tracing_params']['tracing_batch_proccesor'])
