...
def trace_llm_call(func):
    ...
    @wraps(func)
    async def wrapper(self, requests, temperature=0.0, top_p=1.0, max_tokens=40, *args, **kwargs):
        invocation_params = {
        ...
        with tracer.start_as_current_span(
            ...
            result = await func(self, requests, temperature, top_p, max_tokens, *args, **kwargs)
            return result
